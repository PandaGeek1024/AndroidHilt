...
class ButtonsFragment : Fragment() {
    ...
    @Inject lateinit var binder: TestBinder
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        view.findViewById<TextView>(R.id.binder_textView).text = binder.description
        view.findViewById<TextView>(R.id.direct_inject_textView).text = logger.description
        ...
        view.findViewById<Button>(R.id.new_activity).setOnClickListener {
            requireActivity().startActivity(Intent(requireActivity(), MainActivity2::class.java))
        }
    }
}
